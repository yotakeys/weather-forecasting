...
class WeatherForecast:
    ...
    def preProcessing(self):
        ...
        self.test_clean = self.test_clean.drop(['winddirection_10m_dominant (°)'], axis=1)
        # train data
    ...
    def xgBoost(self):
        ...
        if self.mode:
            ...
            self.output.to_csv('submission-16-key.csv', index=False)
            
            
        else:
            from sklearn.model_selection import train_test_split
            x_train, x_test, y_train, y_test = train_test_split(self.X, self.Y, train_size= 0.75, random_state=57)
